...
from app.jobs_ingestion.adapters.theirstack_adapter import TheirStackAdapter
...
__all__ = ["ADAPTER_REGISTRY", "SeedAdapter", "AdzunaAdapter", "JSearchAdapter", "TheirStackAdapter"]
